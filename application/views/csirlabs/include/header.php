...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>includes/csirlabs/assets/vendor/bootstrap/css/bootstrap-datetimepicker.min.css">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<link rel="stylesheet" href="<?php echo base_url();?>includes/admin/assets/libs/css/style.css">
	<link rel="stylesheet" href="<?php echo base_url();?>includes/csirlabs/assets/libs/css/croppie.css">
