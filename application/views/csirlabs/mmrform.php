<div class="col-lg-10 col-md-10 col-sm-10">
	<div class="admin-dashboard">
		<div class="admin-dashboard-content" style="min-height: 90vh; background-color: #337ab7;color: #fff;">
			...
			<form method="post" id="<?php echo $method_prefix;?>-add-nil-data-form" style="padding: 1% 5%;">
				<div class="form-group">
					<div class="row">
						<div class="col-md-12 text-center">
							<h5>If you do not have emloyee details for <?php echo date('d-m-Y', strtotime($start_date));?> to <?php echo date('d-m-Y', strtotime($end_date));?> you can submit your report as NIL by below form</h5>
						</div>	
					</div>
				</div>
				<div class="form-group row">
					<div class="col-md-12">
						...
						<div id="<?php echo $method_prefix;?>-add-nil-data-error" class="margin-bottom-10 text-center"></div>
						<div id="<?php echo $method_prefix;?>-add-nil-data-success" class="margin-bottom-10 text-center"></div>
					</div>
				</div>
				<div class="form-group">
					<div class="row">
				...
				<div class="form-group">
					<div class="row">
						<div class="col-md-12">
							<input type="submit" name="insert" value="Submit NIL Report" class="form-control btn btn-info"/>
						</div>
					</div>
				</div>
			</form>
