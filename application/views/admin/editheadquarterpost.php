				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-12 margin-bottom-10">
							...
							<input type="hidden" name="id" value="<?php echo $headquarterpost['id'];?>">
						</div>
						<div class="col-md-12 margin-bottom-10">
							<label class="margin-bottom-10">* Enter No of Posts</label>
							<input class="form-control" name="posts" type="number" max="1000" min="1" value="<?php echo $headquarterpost['posts'];?>" />
						</div>
						<div class="col-md-12 margin-bottom-10">
							<label class="margin-bottom-10">* Enter Designation</label>
							<input type="text" value="<?php echo $headquarterpost['designation']?>" name="designation" class="form-control" />
						</div>
						<div class="col-md-12 margin-bottom-10">
							...
							<select name="paylevel" class="form-control">
								...
								?>
								<option value="<?php echo $value['id'];?>" <?php if($value['id'] == $headquarterpost['paylevel']){ ?> selected <?php } ?> >
									<?php echo $value['paylevel'];?>
								</option>
								<?php 
									}
								?>
						...
						<div class="col-md-12 margin-bottom-10">
							...
							<select name="category" class="form-control">
								...
								?>
									<option value="<?php echo $value['category_key'];?>" <?php if($value['category_key'] == $headquarterpost['category']){ ?> selected <?php } ?> >
										<?php echo $value['name'];?>
									</option>
								<?php 
									}
						...
						<div class="col-md-12 margin-bottom-10">
							...
							<select name="subcategory" class="form-control">
								...
								?>
									<option value="<?php echo $value['category_key'];?>" <?php if($value['category_key'] == $headquarterpost['subcategory']){ ?> selected <?php } ?> >
										<?php echo $value['name'];?>
									</option>
								<?php 
									}
								?>
									<option value="other" <?php if($headquarterpost['subcategory'] == 'other'){ ?> selected <?php } ?> >
										Other
									</option>
							</select>
						</div>
						<div class="col-md-12 margin-bottom-10">
							...
							<select name="gender" class="form-control">
								...
								?>
								<option value="<?php echo $value['id'];?>" <?php if($value['id'] == $headquarterpost['gender']){ ?> selected <?php } ?> >
									<?php echo $value['name'];?>
								</option>
								<?php 
									}
